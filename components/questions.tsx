...
export default function Questions() {
    return (
        <div className="accordion" id="faq">
            <Question accordionId='faq' question='What is it?' answer={
            ...
            <Question accordionId='faq' question='What video sources does it support?' answer={
            ...
            <Question accordionId='faq' question='Why does it show wrong video?' answer={
                <div>Unfortunately, not all tracks are available in the internet. If it is not on YouTube, try Spotify or Deezer.</div>
            } />
            <Question accordionId='faq' question='Why does it show wrong video?' answer={
                <div>Unfortunately, not all tracks are available in the internet. If it is not on YouTube, try Spotify or Deezer.</div>
            } />
            <Question accordionId='faq' question='Is it free?' answer={
                <div>Yes, it is.</div>
            } />
            <Question accordionId='faq' question='Why does it ask for permisssions?' answer={
                <div>To be able to access and handle video sources and license information.</div>
            } />
            <Question accordionId='faq' question='Can not find answer?' answer={
